...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 List<Integer> neighbors_one_hop = getNeighbors(v);
		 List<Integer> neighbors_two_hop = new ArrayList<Integer>();
		 for(int neighbor : neighbors_one_hop){
			 neighbors_two_hop.addAll(getNeighbors(neighbor)); // find each neighbor's neighbor
		 }
